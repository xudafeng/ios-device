...
const iOSDeployDir = path.resolve('..', 'node_modules', 'ios-deploy');
const iOSDeployPkg = path.join(iOSDeployDir, 'package.json');
const iOSDeployBin = path.join(iOSDeployDir, require(iOSDeployPkg)['bin']);
