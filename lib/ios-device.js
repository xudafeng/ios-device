...
Device.prototype.install = function(appPath) {
  return this._exec('-b', appPath);
};

Device.prototype.installUntilReady = function(appPath) {
  return this
    .install(appPath);
};
...
Device.prototype.reinstall = function(appPath) {
  return this._exec('-r', '-b', appPath);
};
